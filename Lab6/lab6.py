...
while True:
    ...
    if markerIds is not None and 1 in markerIds:
        ...
        for i, (rvec, tvec) in enumerate(zip(rvecs, tvecs)):
            ...
            # 獲取 tvec 的 x, y, z 座標
            x, y, z = tvec[0]
            if (x < 0.1 and x > -0.1 and y < 0.1 and y > -0.1 and z - d < 0.1 and z - d > -0.1):
                detect1 = 1
                break
            ...
            print(text)
            z_update = z_pid.update(50*(z - d), 0)  # 控制無人機的前進和後退
        ...
        for i, (rvec, tvec) in enumerate(zip(rvecs, tvecs)):
            ...
            # 獲取 tvec 的 x, y, z 座標
            x, y, z = tvec[0]
            if (x < 0.3 and x > -0.3 and y < 0.3 and y > -0.3 and z - d < 0.3 and z - d > -0.3):
                break
